...
def index():
    ...
    return render_template('index.html', title = _l("Home"), posts = posts.items,form = form, next_url = next_url, prev_url=prev_url)
...
# def force_error():
#     return 1 / 0  # Це спричинить ZeroDivisionError
